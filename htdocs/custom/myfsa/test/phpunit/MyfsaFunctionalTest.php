...
/**
 * \file    test/phpunit/MyfsaFunctionalTest.php
 * \ingroup myfsa
 ...
 * @package Testmyfsa
 */
class MyfsaFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/myfsa/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('myfsa/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/myfsa/admin/about.php');
		$this->authenticate();
		return $this->assertContains('myfsa/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('myfsawidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMyfsa_MyfsaTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMyfsa_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
